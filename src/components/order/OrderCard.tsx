import { CalendarDays, Clock, Eye, Send, User, Phone } from 'lucide-react';
...
export default function OrderCard({ order, onAssign, onView, className }: OrderCardProps) {
  ...
  return (
    <div
      className={cn(
        'relative flex bg-white rounded-lg border border-neutral-200',
